...
@section('content')
    <x-hero-section>
        ...
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight text-gray-900 md:text-5xl dark:text-white">
            A clear view of your <span class="text-brand-600">privacy</span>
        </h1>
        <p class="max-w-3xl text-lg leading-relaxed text-gray-600 md:text-xl dark:text-gray-400">
    ...
    <x-page-section>
        <div class="grid gap-10 lg:grid-cols-[minmax(0,1fr)_18rem] lg:gap-16">
            <article class="space-y-10 text-gray-600 dark:text-gray-400">
                    ...
                    <div class="grid gap-4 sm:grid-cols-3">
                        ...
                        <x-public.muted-card class="p-5">
                            ...
                            <p class="text-sm leading-relaxed">
                                Submitted details are used to provide the feature you requested.
                            </p>
                        </x-public.muted-card>
                        <x-public.muted-card class="p-5">
                            <p class="mb-1 font-semibold text-gray-900 dark:text-white">You have choices</p>
                            <p class="text-sm leading-relaxed">
                                You can unsubscribe or request access, correction, or deletion.
                            </p>
                        </x-public.muted-card>
                    </div>
                </section>
                ...
                <section aria-labelledby="privacy-automatic">
                    <h2
                        ...
                        class="mb-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"
                    >
                        Site operation and analytics
                    </h2>
                    <div class="space-y-4 leading-relaxed">
                        <p>
                            Laravel uses essential session and security cookies to protect forms, preserve validation
                            messages, and support authenticated administration. The server may process standard request
                            information such as IP address, browser details, requested URL, and timestamps for security,
                            rate limiting, and operational logs.
                        </p>
                        <p>
                            The contact form uses Cloudflare Turnstile to distinguish legitimate submissions from
                            automated abuse. Cloudflare may process connection and browser information needed to perform
                ...
                <section aria-labelledby="privacy-use">
                    <h2 id="privacy-use" class="mb-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    ...
                    <p class="leading-relaxed">
                        ...
                        or protect the site and its users. Those providers process information under their own terms and
                        privacy notices.
                    </p>
                </section>
                ...
                <section aria-labelledby="privacy-updates">
                    ...
                    <p class="leading-relaxed">
                        This notice may change as the site and its services evolve. Material updates will be reflected
            ...
            <aside class="lg:sticky lg:top-24 lg:self-start" aria-label="Privacy contact">
                <x-card class="p-6">
                    <p class="text-brand-600 dark:text-brand-300 mb-2 text-xs font-semibold tracking-widest uppercase">
