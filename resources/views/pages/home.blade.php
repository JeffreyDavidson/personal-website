...
@section('content')
    ...
    {{-- ===== LATEST POSTS ===== --}}
    <section class="writing-section dark:border-brand-800/50 border-t border-gray-200 bg-gray-50 py-14 sm:py-24 dark:bg-transparent">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    @if ($latestPosts->count() > 1)
                        <div class="grid gap-6 md:grid-cols-2">
                            @foreach ($latestPosts->skip(1) as $post)
                                <article class="group fade-up hover:border-brand-600/40 dark:border-brand-800/50 dark:bg-brand-900/60 overflow-hidden rounded-xl border border-gray-200 bg-white transition-colors duration-200">
                                    <a
            ...
            <div class="fade-up mt-12 sm:mt-16">
    ...
    {{-- ===== MEDIA ===== --}}
    <section class="media-section dark:border-brand-800/50 border-t border-gray-200 bg-white py-14 sm:py-24 dark:bg-transparent">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
