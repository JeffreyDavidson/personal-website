...
@section('content')
    <x-hero-section>
        ...
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight text-gray-900 md:text-5xl dark:text-white">
            Share your <span class="text-brand-600">experience</span>
        </h1>
        <p class="max-w-2xl text-lg leading-relaxed text-gray-600 md:text-xl dark:text-gray-400">
            Worked with me on a Laravel project, modernization effort, or technical review? Your perspective helps
            future collaborators know what to expect.
        </p>
    </x-hero-section>
                ...
                <form action="{{ route('testimonials.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            <label
                                ...
                                class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                            >Role <span class="text-gray-500">(optional)</span></label>
                            <x-form.input
                                id="testimonial-role"
                                name="role"
                                maxlength="100"
                                value="{{ old('role') }}"
                                placeholder="CTO, developer, founder…"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        <label
                            ...
                            class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >Company <span class="text-gray-500">(optional)</span></label>
                        <x-form.input
                    ...
                    <div>
                        ...
                        <x-form.textarea
                            ...
                            required
                            maxlength="1000"
                            aria-describedby="testimonial-body-help"
                            aria-invalid="{{ $errors->has('body') ? 'true' : 'false' }}"
                        >
                            {{ old('body') }}</x-form.textarea>
                        <p id="testimonial-body-help" class="mt-2 text-sm text-gray-500">
                    ...
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <p class="text-xs leading-relaxed text-gray-500 sm:max-w-xs sm:text-right">
                            Approved submissions may be displayed publicly.
                            <a
                                href="{{ route('privacy') }}"
