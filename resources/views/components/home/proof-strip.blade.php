...
<section
    {{ $attributes->class(['border-y border-gray-200 bg-white py-10 dark:border-brand-800/50 dark:bg-transparent sm:py-14']) }}
    aria-label="Experience and published work"
>
