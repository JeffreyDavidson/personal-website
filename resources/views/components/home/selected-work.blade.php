        ...
        <div class="divide-y divide-brand-800 border-y border-brand-800">
            @foreach($projects as $project)
                <article data-project-entry class="py-8 sm:py-12">
                    <a href="{{ route('projects.show', $project) }}" aria-label="Preview {{ $project->title }}" class="mb-8 block rounded-xl focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand-300">
