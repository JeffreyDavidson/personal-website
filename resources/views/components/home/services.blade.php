<section data-home-services aria-labelledby="services-heading" class="border-t border-gray-200 bg-white py-14 dark:border-brand-800/50 dark:bg-transparent sm:py-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <dl class="grid gap-8 md:grid-cols-3 md:gap-10">
            ...
            <div>
                <dt>
                    <x-heroicon-o-shield-check class="mb-5 size-8 stroke-brand-600 dark:stroke-brand-300" aria-hidden="true" />
                    <span class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Ship with confidence</span>
                </dt>
                <dd class="mt-3 max-w-sm text-base leading-7 text-gray-600 dark:text-gray-400">Protect critical workflows with automated tests, repeatable deployments, and visibility into production errors.</dd>
            </div>
        </dl>
    </div>
</section>
