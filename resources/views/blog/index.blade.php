...
@section('content')
    <div class="blog-index bg-gray-50 dark:bg-[#0b1016]" data-blog-filter>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="blog-index__filters flex flex-col gap-5 border-b border-gray-200 py-6 lg:flex-row lg:items-center lg:justify-between dark:border-[#1e2a3a]">
                <div class="relative w-full lg:max-w-sm">
                    ...
                    <button
                        ...
                        class="text-brand-600 hover:text-brand-500 focus-visible:outline-brand-500 absolute inset-y-0 right-3 rounded px-1 text-sm font-medium focus-visible:outline-2"
                    >
                        Clear
                    </button>
                </div>
            ...
            <section aria-labelledby="blog-heading" class="py-10 md:py-14">
                <div class="blog-index__grid">
                    ...
                    <div hidden data-blog-empty class="col-span-full py-20 text-center">
                        ...
                        <p class="mt-2 text-gray-600 dark:text-gray-400">
                            Nothing matched “<span data-blog-empty-query></span>”. Try another search or category.
                        </p>
                        <button
                            type="button"
                            data-blog-reset
                            class="hover:border-brand-500 hover:text-brand-600 focus-visible:outline-brand-500 dark:border-brand-700 dark:bg-brand-950 mt-5 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-base font-medium text-gray-800 focus-visible:outline-2 focus-visible:outline-offset-2 dark:text-gray-100"
                        >
                            Show all articles
                        </button>
                    </div>
