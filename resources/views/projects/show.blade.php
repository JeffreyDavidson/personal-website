    ...
    <section aria-labelledby="project-overview" class="py-12 sm:py-16">
        <div class="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,2fr)] lg:gap-16 lg:px-8">
            ...
            <div class="min-w-0">
                ...
                @else
                    <p class="text-lg leading-8 text-gray-600 dark:text-gray-400">The full project story is coming soon. Get in touch to discuss the problem, my contribution, and how the work relates to what you’re building.</p>
                @endif
            </div>
        </div>
    </section>
